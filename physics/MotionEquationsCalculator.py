...
def eq2(a, b, c, d):
    if a == "?":
        ...
        try:
            answer = (
                -float(b) + math.sqrt(float(b) ** 2 + float(2) * float(c) * float(a))
            ) / float(c)
            if answer < 0:
                return "Time", answer * float(-1)
            else:
...
def main(Type):
    if Type == "ds":
        ...
        if which == "d":
            Givens = input("Givens (order: s d t. If haven't got then put in ?): ")
            a = give(Givens)
            s, d, t = a[0], a[1], a[2]
            ...
            Givens = input("Givens (order: v s t. If haven't got then put in ?): ")
            a = give(Givens)
            v, s, t = a[0], a[1], a[2]
        ...
        if which == "1":
            Givens = input("Givens (order: v u a t. If haven't got then put in ?): ")
            a = give(Givens)
            ...
            Givens = input("Givens (order: s u a t. If haven't got then put in ?): ")
            a = give(Givens)
            ...
            Givens = input("Givens (order: v u a s. If haven't got then put in ?): ")
            a = give(Givens)
            ...
            Givens = input("Givens (order: a v u t. If haven't got then put in ?): ")
            a = give(Givens)
